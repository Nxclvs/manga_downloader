...
browser.get('https://chapmanganelo.com/manga-eh88875')
time.sleep(3)
...
# for i in range(2):
    ...
    chapter_text = chapter_text.replace('Notice.', '')
    chapter_text = chapter_text.replace('Chapter', '')
...
for entries in result_list:
    ...
    if not os.path.exists(r'F:\BlackClover\Chapter ' + entries[0]):
        os.mkdir(r'F:\BlackClover\Chapter ' + entries[0])

    os.chdir(r'F:\BlackClover\Chapter ' + entries[0])
