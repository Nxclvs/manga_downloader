...
browser.get('https://chapmanganelo.com/manga-od92597')
time.sleep(3)
...
# for i in range(2):
    ...
    print("Chapter {}".format(chapter_text))
    chapters[i].click()
    time.sleep(3)
...
for entries in result_list:
    ...
    if not os.path.exists(r'F:\TokyoGhoul\Chapter ' + entries[0]):
        os.mkdir(r'F:\TokyoGhoul\Chapter ' + entries[0])

    os.chdir(r'F:\TokyoGhoul\Chapter ' + entries[0])
